...
namespace database
{
    ...
    std::optional<User> User::read_by_id(long id)
    {
        try
        {
            ...
            std::string select_str = "SELECT id, total_id, first_name, last_name, email,title, login, password FROM User where total_id=? ";
    ...
    std::vector<User> User::read_all(long id)
    {
        try
        {
            ...
            User a;
            std::string sharding_hint = database::Database::sharding_hint(id);
            std::string select_str = "SELECT id, total_id, first_name, last_name, email,title, login, password FROM User ";
            select_str += sharding_hint;
            std::cout << select_str << std::endl;
            ...
            auto handle = std::async(std::launch::async, [first_name, last_name, hint]() mutable -> std::vector<User>
                                     {
                                        ...
                                        Poco::Data::Session session = database::Database::get().create_session();
                                        Statement select(session);
                                        std::string select_str = "SELECT id, total_id, first_name, last_name, email,title, login, password FROM User where first_name='";
            ...
            auto handle = std::async(std::launch::async, [login, hint]() mutable -> std::vector<User>
                                     {
                                        ...
                                        Poco::Data::Session session = database::Database::get().create_session();
                                        Statement select(session);
                                        std::string select_str = "SELECT id, total_id, first_name, last_name, email,title, login, password FROM User where login='";
                                        select_str += login;
                                        select_str += "'";
                                        select_str += hint;
                                        select << select_str;
    ...
    void User::save_to_mysql()
    {
        ...
        try
        {
            ...
            std::string select_str = "INSERT INTO User (total_id, first_name,last_name,email,title,login,password) VALUES(?, ?, ?, ?,?, ?, ?) ";
            select_str += sharding_hint;
            std::cout << select_str << std::endl;
